...
neutral_h2 = 1;
fScale = 5;
w = neutral_w +  2%av_train.visual(1,88);
h1 = neutral_h1 + 2%av_train.visual(2,88);
h2 = neutral_h2 + 2%av_train.visual(3,88);
...
newmesh.vertex(:,2), newmesh.vertex(:,1) = interpVert(mesh.vertex(:,1),mesh.vertex(:,2),neutral_w, neutral_h1, neutral_h2, w, h1, h2, fScale);
